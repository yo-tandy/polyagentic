...
class InnesAgent(Agent):
    ...
    Session-based (stateful). Git actions (create_repo, review_pr,
    merge_pr, request_changes) are handled centrally via the
    ActionRegistry, which accesses _git_manager and _project_store
    set by configure_extras().
    """
    ...
    def __init__(self, model: str, messages_dir: Path, working_dir: Path):
        ...
        self._register_prompt_files("innes")
